...
class Common_Pinyin extends Controller{


	static public function translate($_String, $_Code='gb2312',$isInitial=false)
	{
		preg_match('/^[\d]{1,}/',$_String,$prefix);
		$_String= preg_replace('/^[\d]{1,}/','',$_String);
		...
		if(!empty($prefix))
		{
			return $prefix[0].preg_replace("/[^a-z0-9A-Z]/", '', $_Res);
		}
