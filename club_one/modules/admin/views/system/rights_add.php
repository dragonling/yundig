...
<script type='text/javascript' src="<?php echo Kohana::$base_url ?>assets/admin/javascript/rights.js"></script>

<div class="container">
	<div class="content_box">
	<div class="content form_content">
	
		<form name='edit_form' id='edit_form' method='post' action='<?php echo URL::site('admin/system/rights/save') ?>'>
			...
			<table id="list_table" class="form_table">
				...
				<tbody>
					<tr>
						<th><?php echo I18n::get('right_name', 'system')?>:</th>
						<td><input type="text" name="name" id="name" class="middle" value="<?php echo $data->name ?>"></td>
					</tr>
					<tr class="language">
						<th><?php echo I18n::get('parent_section', 'system')?>:</th>
						<td>
							<?php echo Form::select('parent_id', $rights, $data->parent_id); ?>
						</td>
					</tr>
					<tr class="language">
						<th><?php echo I18n::get('right_type', 'system')?>:</th>
						<td>
							<?php echo Form::select('type', I18n::get('data_types', 'system'), $data->type, array('id' => 'right_type', 'onchange' => 'change_type(this.value)')) ?>
						</td>
					</tr>
					<tr>
						<th><?php echo I18n::get('text_bind_catalog', 'system')?>:</th>
						<td>
							<?php echo Form::select('catalog_id', $catalog_options, $data->catalog_id) ?>
						</td>
					</tr>
					<tr class="language">
						<th><?php echo I18n::get('right_status', 'system')?>:</th>
						<td>
							<?php echo Form::select('status', I18n::get('data_status', 'common'), $data->status) ?>
						</td>
					</tr>
					<tr class="language">
						<th><?php echo I18n::get('text_sort', 'system')?>:</th>
						<td><input type="text" name="sort_order" id="sort_order" class="middle" value="<?php echo $data->sort_order ?>"></td>
					</tr>
					<tr class="right_sets language">
						<th><?php echo I18n::get('right_sets', 'system')?>:</th>
						<td>
							<table style="width: 310px;" class="border_table">
								<thead>
									<tr><th><?php echo I18n::get('right_code', 'system')?></th><th><?php echo I18n::get('text_delete', 'common')?></th></tr>
								</thead>
								<tbody id="rightBox">
