...
<div id="tabs">
    <ul>
        <li style="float:right"><button type="button" id="add_tab" class="btn"> Add Tab </button></li>
	...
	<div id="tabs-<?php echo $i ?>" aria-labelledby="ui-id-<?php echo $i ?>" class="ui-tabs-panel ui-widget-content" <?php echo $i > 0 ? 'style="display:none"' : '' ?>>
		...
		<p>内容: <?php echo View::factory('widget/editor', array('field' => "contents_{$i}", 'value' => $v->content, 'lang' => isset($lang) ? $lang : 'zh_CN')) ?></p>
		<p></p>
	</div>
	<?php } ?>
</div>