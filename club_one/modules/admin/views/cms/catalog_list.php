...
<div class="headbar">
	<div class="operating">
		...
		<button class="operating_btn" type="button"><span class="addition"><?php echo I18n::get('btn_associate_other', 'cns') ?></span></button></a>
		<?php } ?>
	...
	<div class="searchbar">
		<form method="post">
		Filter:	<input type="text" > <button class="btn"><span class="search">Submit</span></button>
		</form>
	</div>
	<div class="field">
		<table class="list_table">
			...
			<?php 
				foreach ($columns as $k => $col) { 
					echo ($k != 'id' && $k != 'status') ? '<col '. (isset($col['attribute']) ? $col['attribute'] : '') .'/>' : '<col width="80px" />';
				}
			?>			
			<col width="100px" />
			<thead>
				<tr>
                    ...
                    <th <?php echo isset($col['attribute']) ? $col['attribute'] : ''; ?>><?php echo $col['name']?></th>
                    <?php } ?>
