...
class Common_Main{
	...
	public function sub($id, $status = NULL, $args = array())
	{
		...
		{
			$data = $this->bind_language($this->_model_name, $data, Common_Main::language_id());
		}
		return $data;
	}
	/**
	...
	{
		$cache_id = 'TREEVIEWS_DATA_'.strtoupper($this->_model_name).$parent_id.Common_Main::language_id().md5(implode(',', $columns)).$status;
