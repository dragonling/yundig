...
<div class="pages_bar">
	<p class="inle-pag">
		...
		<?php else: ?>
			<span href='#' class="disabled"><?php echo __('First') ?></span>
		<?php endif ?>

		<?php if ($previous_page !== FALSE): ?>
			<a href="<?php echo HTML::chars($page->url($previous_page)) ?>" rel="prev"><?php echo __('Prev') ?></a>
		<?php else: ?>
			<span href='#' class="disabled"><?php echo __('Prev') ?></span>
		<?php endif ?>
		
		<?php foreach ($links as $i => $v) : ?>
			<?php if ($i == $current_page): ?>
				<span class="current"><?php echo $v ?></span>
			<?php else: ?>
		...
		<?php else: ?>
			<span href='#' class="disabled"><?php echo __('Next') ?></span>
		<?php endif ?>

		<?php if ($last_page !== FALSE): ?>
			<a href="<?php echo HTML::chars($page->url($last_page)) ?>" rel="last"><?php echo __('Last') ?></a>
		<?php else: ?>
			<span href='#' class="disabled"><?php echo __('Last') ?></span>
		<?php endif ?>
