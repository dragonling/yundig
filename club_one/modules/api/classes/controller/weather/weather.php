 ...
 *
 */
class Controller_Weather_Weather extends Controller_Api{
	...
	public function action_index()
	{
		...
		//TODO
		$city = isset($_GET['city'])?trim($_GET['city']):Controller_Ip_Ip::getCity_ip138($ip);		
		//print_r($city);die;
		...
		if($output == false)
		{
			...
			if($output)
			Xcache::add_tag($this->key, $output,3600*24,array("API_WEATHER"));
		}
		//将数组格式化输出
