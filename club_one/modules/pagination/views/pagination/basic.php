...
<div class="pages_bar">
	<p class="inle-pag">
		...
		<?php if ($first_page !== FALSE): ?>
			<a href="<?php echo HTML::chars($page->url($first_page)) ?>" rel="first"><?php echo __('首页') ?></a>
		<?php else: ?>
			<a href='#' class="disabled"><?php echo __('首页') ?></a>
		<?php endif ?>

		<?php if ($previous_page !== FALSE): ?>
			<a href="<?php echo HTML::chars($page->url($previous_page)) ?>" rel="prev"><?php echo __('上一页') ?></a>
		<?php else: ?>
			<a href='#' class="disabled"><?php echo __('上一页') ?></a>
		<?php endif ?>
		
		<?php foreach ($links as $i => $v) : ?>
			<?php if ($i == $current_page): ?>
				<a class="current_page" href="<?php echo HTML::chars($page->url($i)) ?>"><?php echo $v ?></a>
			<?php else: ?>
				<a href="<?php echo HTML::chars($page->url($i)) ?>"><?php echo $v ?></a>
			<?php endif ?>	
		<?php endforeach ?>
		...
		<?php else: ?>
			<a href='#' class="disabled"><?php echo __('下一页') ?></a>
		<?php endif ?>

		<?php if ($last_page !== FALSE): ?>
			<a href="<?php echo HTML::chars($page->url($last_page)) ?>" rel="last"><?php echo __('最后一页') ?></a>
		<?php else: ?>
			<a href='#' class="disabled"><?php echo __('最后一页') ?></a>
		<?php endif ?>
